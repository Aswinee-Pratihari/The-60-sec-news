...
<h1 class="sm:text-5xl text-3xl py-10 font-medium title-font mb-4 text-gray-900">TOP NEWS OF THE DAY</h1>
  <img class="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" alt="hero" src={"https://images.moneycontrol.com/static-mcnews/2017/03/accenture_720-770x433.jpg"}/>
